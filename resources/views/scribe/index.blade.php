    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="order">
                    <a href="#order">Order</a>
                                    ...
                                    <ul id="tocify-subheader-order" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="order-GETapi-orders">
                                <a href="#order-GETapi-orders">View order</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-GETapi-orders--id-">
                                <a href="#order-GETapi-orders--id-">show order</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-POSTapi-orders">
                                <a href="#order-POSTapi-orders">Create order</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-PUTapi-orders--id-">
                                <a href="#order-PUTapi-orders--id-">update order</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-DELETEapi-orders--id-">
                                <a href="#order-DELETEapi-orders--id-">delete order</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="product">
                    <a href="#product">Product</a>
                                ...
                                <a href="#product-GETapi-products">View product</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="product-GETapi-products--id-">
                                <a href="#product-GETapi-products--id-">update product</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="product-POSTapi-products">
                                <a href="#product-POSTapi-products">Create product</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="product-PUTapi-products--id-">
                                <a href="#product-PUTapi-products--id-">update product</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="product-DELETEapi-products--id-">
                                <a href="#product-DELETEapi-products--id-">delete product</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="user">
                    <a href="#user">User</a>
                                ...
                                <a href="#user-POSTapi-register">Đăng ký users</a>
                            </li>
...
Trả về message</a>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: June 22, 2023</li>
    </ul>
</div>
...
<p>A simple REST API in Laravel</p>
<aside>
...
<p>You can retrieve your token by logging in to your account.</p>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs for managing Order</p>

                                <h2 id="order-GETapi-orders">View order</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Data trả về list danh sách product</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="order-GETapi-orders--id-">show order</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Kết quả trả về file json order</p>
...
<p>Example : 1 Example: <code>2</code></p>
                    ...
                    <h2 id="order-POSTapi-orders">Create order</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               name="order_total"                data-endpoint="POSTapi-orders"
               value="1"
               data-component="body">
    <br>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               name="product_id"                data-endpoint="POSTapi-orders"
               value="1"
               data-component="body">
    <br>
<p>Example: <code>1</code></p>
                    ...
                    <h2 id="order-PUTapi-orders--id-">update order</h2>
...
<p>Example : 3 Example: <code>6</code></p>
                    ...
                    <h2 id="order-DELETEapi-orders--id-">delete order</h2>
...
&quot;OK&quot;
    ...
    <p>APIs for managing Product</p>
                                ...
                                <h2 id="product-GETapi-products">View product</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="product-GETapi-products--id-">update product</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Kết quả trả về file json product</p>
...
&quot;data&quot;: {
  &quot;id&quot;: 1,
  &quot;product_name&quot;: &quot;C&aacute;i B&agrave;n 1&quot;,
  &quot;product_price&quot;: &quot;2000&quot;,
  &quot;product_image&quot;: &quot;1&quot;,
   &quot;product_status&quot;: 1
}</code>
...
<p>Example :1* Example: <code>repellat</code></p>
                    ...
                    <h2 id="product-POSTapi-products">Create product</h2>
...
&quot;data&quot;: {
  &quot;id&quot;: 1,
  &quot;product_name&quot;: &quot;C&aacute;i B&agrave;n&quot;,
  &quot;product_price&quot;: &quot;2000&quot;,
  &quot;product_image&quot;: &quot;1&quot;,
   &quot;product_status&quot;: 1
}</code>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="product_price"                data-endpoint="POSTapi-products"
               value="2000"
               data-component="body">
    <br>
<p>Example: <code>2000</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>xxxxxx</code></p>
        </div>
        </form>

                    <h2 id="product-PUTapi-products--id-">update product</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>Cái Bàn1</code></p>
        </div>
        </form>

                    <h2 id="product-DELETEapi-products--id-">delete product</h2>
...
<p>Example :1 Example: <code>autem</code></p>
    ...
    <p>APIs for managing Users</p>
                                ...
                                <h2 id="user-POSTapi-register">Đăng ký users</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Kết quả trả về file json user</p>
...
<p>This endpoint is used to login a user to the system.</p>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;token_type&quot;: &quot;Bearer&quot;
            ...
            <blockquote>
            <p>Example response (401, Failed Login):</p>
        </blockquote>
                <pre>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-GETapi-users--id-">Show 1 user</h2>
...
<p>Example: <code>1</code></p>
                    ...
                    <h2 id="user-POSTapi-users">Create users</h2>
...
<p>Example: <code>BSj9X?7te5?}a_!a[</code></p>
                    ...
                    <h2 id="user-PUTapi-users--id-">update user</h2>
...
<p>Example: <code>quasi</code></p>
                    ...
                    <h2 id="user-DELETEapi-users--id-">Delete user
Trả về message</h2>
...
<code class="language-json" style="max-height: 300px;">{&quot;message : OK&quot;}</code>
 </pre>
    </span>
